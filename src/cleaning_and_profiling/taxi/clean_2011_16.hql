...
from raw_data_2015 
where pickup_latitude>=40.69715 and pickup_latitude<=40.862752 and pickup_longitude>=-74.022208 and pickup_longitude<=-73.924361
and trip_distance>=0 and trip_distance<=4;