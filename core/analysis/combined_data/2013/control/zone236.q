...
insert overwrite table zone236_changes select month, ((taxi_year2 - taxi_year1)/taxi_year1) * 100, ((taxi_year3 - taxi_year1)/taxi_year1) * 100, ((subway_year2 - subway_year1)/subway_year1) * 100, ((subway_year3 - subway_year1)/subway_year1) * 100 from zone236;

drop table zone236_year1;
drop table zone236_year2;
drop table zone236_year3;
drop table zone236;
